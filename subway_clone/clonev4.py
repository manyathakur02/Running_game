...
class Game:
    ...
    def reset(self):
        ...
        self.coins = []
        self.score = 0.0
        self.coins_collected = 0  # NEW: Absolute tracker for picked up coins
    ...
    def update(self, events):
        ...
        for coin in self.coins:
            if not coin.collected and player_rect.colliderect(coin.rect):
                coin.collected = True
                self.coins_collected += 1  # NEW: Increments collection metric
                self.score += 25
    ...
    def _draw_hud(self):
        ...
        # NEW: Displays absolute coins count on the HUD in thematic gold
    ...
    def _draw_game_over(self):
        ...
        self.screen.blit(over_surf, over_surf.get_rect(center=(WIDTH // 2, HEIGHT // 2 - 170)))

        stats = [
            f"Score: {int(self.score)}",
            f"Coins Collected: {self.coins_collected}",  # NEW: Summary stat
